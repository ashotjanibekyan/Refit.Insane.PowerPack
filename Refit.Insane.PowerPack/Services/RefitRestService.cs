...
public class RefitRestService : IRestService
{
    ...
    public RefitRestService(IReadOnlyDictionary<Type, DelegatingHandler> handlerImplementations, RefitSettings refitSettings) : this(
    ...
    {
        return Execute(executeApiMethod);
    }
    ...
    protected virtual Task<bool> CanPrepareResponse(ApiException fromApiException)
    {
