...
{
    /// <summary>
    ///     By default IPersistedCache (Akavache) - LocalMachine. This data is preserved between app run but may get deleted
    ...
    /// <summary>
    ///     By default IPersistedCache (Akavache) - UserAccount. This data is preserved between app run and might be
    ///     automatically synchronized to cloud (like iCloud on iOS)
    ///     Ideal for things like user settings etc.. but don't use for passwords and sensitive data.
    /// </summary>
    UserAccount,

    /// <summary>
    ///     By default IPersistedCache (Akavache) - Secure. This data is preserved between app run and might be automatically
    ///     synchronized to cloud (like iCloud on iOS)
